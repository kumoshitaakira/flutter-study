...
abstract class $AccountModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String userName, DateTime birthDay});
}
...
class _$AccountModelImpl implements _AccountModel {
  const _$AccountModelImpl(
      {required this.id, required this.userName, required this.birthDay});
  ...
  @override
  String toString() {
    return 'AccountModel(id: $id, userName: $userName, birthDay: $birthDay)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userName, birthDay);
...
abstract class _AccountModel implements AccountModel {
  const factory _AccountModel(
      ...
      required final DateTime birthDay}) = _$AccountModelImpl;
